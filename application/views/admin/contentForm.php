			...
			<div class="col-lg">
				<div class="p-5">
					...
					<form method="post" enctype="multipart/form-data">
						...
						<div class="form-group row">
							<label for="name" class="col-sm-3 col-form-label">Url Login</label>
							<div class="col-sm">
								<input type="text" class="form-control" id="name" name="linkLogin" placeholder="Url/Link Login">
							</div>
						</div>
						<div class="form-group row">
							<label for="name" class="col-sm-3 col-form-label">Url Daftar</label>
							<div class="col-sm">
								<input type="text" class="form-control" id="name" name="linkRegis" placeholder="Url/Link Daftar">
							</div>
						</div>
						<div class="form-group row">
